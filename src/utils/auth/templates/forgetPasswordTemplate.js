const forgetPasswordTemplate = (code) => {
  return `
          ...
          <table width="800" cellpadding="0" cellspacing="0" border="0" style="background-color: #ffffff; font-family: 'Raleway', sans-serif; border-radius: 10px; overflow: hidden; margin: 0 auto;">
            ...
            <tr>
              <td style="padding: 30px; font-size: 18px; text-align: justify; color: black;">
                <p>We received a request to reset your password. To proceed, please enter the verification code below on the password reset page.</p>
                ...
                <p>This code is valid for <strong>5 minutes</strong>. If you didn’t request a password reset, feel free to ignore this email.</p>
